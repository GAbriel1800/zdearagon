const users = [
    { username: 'GabrielRey', password: 'admin123', name: 'Gabriel', role: 'admin' },
    { username: 'Pablo', password: 'pablo456', name: 'Pablo', role: 'worker' },
    { username: 'Martin', password: 'martin789', name: 'Martin', role: 'worker' }
];
